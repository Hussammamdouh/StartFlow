 ...
 * tags:
 *   - name: AI Status
 *     description: AI service health and status endpoints
 *   - name: AI Recommendations
 *     description: Company recommendation features
 *   - name: AI Predictions
 *     description: Machine learning prediction features
 */
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/info', aiController.getAIInfo);
 ...
 *               details: "Connection refused"
 */
router.post('/recommendations', aiController.getCompanyRecommendations);
 ...
 */
router.post('/predict-startup-success', aiController.predictStartupSuccess);
